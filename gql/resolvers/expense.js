...
module.exports = {
  Query: {
    ...
    fetchExpenses: combineResolvers(async (parent, args, context) => {
      try {
  ...
  Mutation: {
    ...
    createReport: combineResolvers(async (parent, { reportInput }, context) => {
      try {
    ...
    updateReport: combineResolvers(async (parent, { reportInput }, context) => {
      try {
